...
ExportToOfficeHelper.prototype.saveContentToFile = function (
	...
	if (ext.indexOf('excel') !== -1) {
		...
		fileNamePrefix = fileName || this.aras.getResource(
			'',
		...
		fileNamePrefix = fileName || 'export2unknown_type';
	}
...
ExportToOfficeHelper.prototype.exportToWord = function (content, itemNode, fileName) {
	...
	this.saveContentToFile(html, 'word', fileName);
};
...
ExportToOfficeHelper.prototype.exportToExcel = function (
	...
	this.saveContentToFile(result, 'excel', fileName);
};
