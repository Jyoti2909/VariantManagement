...
{
	public class RfcConfigParameters : Dictionary<string, string>, IDisposable
	{
		...
		public const string NoBasXml = "NO_BASXML";
		...
		public const string PoolIdleTimeout = "POOL_IDLE_TIMEOUT";
		public const string ConnectionIdleTimeout = "IDLE_TIMEOUT";
		public const string RepositoryConnectionIdleTimeout = "REP_CONN_IDLE_TIMEOUT";
		[Obsolete("use ConnectionIdleTimeout instead")]
		...
		public const string UseSymbolicNames = "USE_SYMBOLIC_NAMES";
		private static int failedLoadConfigCount;
		private SecureString securePassword;
		private SecureString secureRepositoryPassword;

		public RfcConfigParameters()
		{
		}
